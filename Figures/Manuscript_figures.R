...
curated_list_naive <- read.csv('../Manual Curation/Curated list_naive.csv', sep='\t')
...
## Load Modeling Resutls
load(file = '../Modeling/all_results.Rdata')
load(file = '../Modeling/all_param_naive.Rdata')
load(file = '../Modeling/all_param_lpa.Rdata')

all_param <- list(naive=all_param_naive, lpa=all_param_lpa)
rm('all_param_naive', "all_param_lpa")
